#!/bin/csh -f
# Minimal runscript: mom4p1_coupled


set platform      = ia64           # A unique identifier for your platform
set name          = MOM_SIS_TOPAZ      # Name of the experiment you want to run
                                   # Currently one of: om3_core3 , atlantic1 , MOM_SIS_TOPAZ
set npes          = 24             # number of processor
                                   # Note: If you change npes you may need to change
                                   # the layout in the corresponding namelist
set type          = mom4p1_coupled # type of the experiment
...
#    else  
    ...
    echo "Please make sure that the variable 'name' in this script is set to one of atlantic1, om3_core1 , om3_core3 , om3_ecosystem_mdfl_generic."
